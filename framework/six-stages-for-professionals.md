# The six stages, for a professional
...
| **Observer** | You read about it and watch colleagues. You haven't really started. | Permission to try something messy on low-stakes work. |
| **Dabbler** | You use it occasionally, when you remember. Results are hit-and-miss. | Two or three tasks where it works every time. |
| **Integrator** | AI is part of how you work. You save real time and know its limits. | A question, not a course: *what could you build with this — for others?* |
| **Architect** | You can see something you'd build, and you understand the problem — but you haven't committed to being the person who builds it. | Permission, and proximity to a peer one stage ahead. |
| **Innovator** | You build things other people use, and you keep noticing what's broken that nobody fixes. | Choosing which problem is worth your attention. |
...
- **Proximity** to a peer one stage ahead who isn't extraordinary — it breaks the assumption that the next step belongs to a different kind of person.
- **The right question** — "whose problem do you keep noticing that nobody's solving?"
- **Specific permission** from someone credible who can say, without hedging, *you have what this takes.*

## The ICE Method, for your role
...
The [role paths](../templates/role-paths.md) give a quick-start Improve/Create cut for common roles — marketer, manager, ops, customer-facing, HR, analyst, educator — so you can skip straight to what's worth trying first in *your* job.
